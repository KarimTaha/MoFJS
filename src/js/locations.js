export function getLocationName(id) {
  switch (id) {
    ...
    case "251":
      return "سفارة الإمارات العربية المتحدة – نايبيداو – ميانمار";
    case "252":
      return "L252: سفارة الإمارات العربية المتحدة – تل ابيب  – اسرائيل";
    case "253":
      return "L253: مركز تأشيرات - كاتماندو";
    case "254":
      return "L254 : سفارة دولة الامارات فى بيشكيك - قرغيزستان";
    case "300":
      return "أفريقيا";
    case "301":
    ...
    case "335":
      return "سفارة الإمارات العربية المتحدة – موروني – جزر القمر";
    case "336":
      return "مكتب الإمارات العربية المتحدة – هيرجيسيا - صوماليلاند";
    case "337":
      return "L337: سفارة الإمارات العربية المتحدة – فريتاون – سيراليون";
    case "338":
      return "338: سفارة دولة الامارات العربية المتحدة - كينشاسا";
    case "339":
      return "L339: قنصلية الإمارات العربية المتحدة – العيون - المغرب";
    case "340":
      return "L340: مركز تأشيرات - لاغوس";
    case "400":
      return "أوروبا";
    case "401":
    ...
    case "440":
      return "القنصلية العامة لدولة الإمارات العربية المتحدة - جينيف";
    case "500":
    ...
    case "610":
      return "سفارة الإمارات العربية المتحدة – سوفا – فيجي";
    case "611":
      return "سفارة الإمارات العربية المتحدة – سانتو دومينغو – جمهورية الدومينيكان";
    case "900":
      return "مواقع أخرى";
    case "800":
